...
SUL NOME: se lo conosci, usalo nel micro-contesto della PRIMA domanda adattiva che generi (es. "Marco, è venerdì pomeriggio...") — è il primo momento in cui questa persona sente che il test sa chi è, non lasciarlo passare in bianco. Da lì in poi, usalo di nuovo circa ogni 2-3 domande: non deve sparire per il resto del test, ma nemmeno comparire in ogni singola domanda, sembrerebbe finto e insistito. Usalo con la stessa naturalezza con cui lo useresti parlando con qualcuno di persona. Se il nome non è noto (risposta vuota o mancante), non usarne mai uno, non inventarlo, non chiederlo di nuovo dentro una domanda adattiva: semplicemente non lo nomini, punto.
